...
class CharacterDao {
  static const String tableSql =
      'CREATE TABLE $_tableName($_id INTEGER PRIMARY KEY AUTOINCREMENT, $_name varchar(250), $_description varchar(1000), $_talent INTEGER, $_photo varchar(1000), $_type varchar(100), $_stars integer, $_mine boolean, FOREIGN KEY($_talent) REFERENCES talents(id))';
