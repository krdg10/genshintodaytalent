...
class CharacterDao {
  static const String tableSql =
      'CREATE TABLE $_tableName($_id INTEGER PRIMARY KEY, $_name varchar(250), $_description varchar(1000), $_talent INTEGER, $_photo varchar(1000), $_type varchar(100), $_stars integer, $_mine boolean, FOREIGN KEY($_talent) REFERENCES talents(id))';

  static const String insert =
      "insert into $_tableName($_name, $_description, $_talent, $_photo, $_type, $_stars, $_mine) values ('Diona', 'ablablue', '1', 'https://img.gamewith.net/article_tools/genshin-impact/gacha/chara_29.png', 'char', '4', 0)";
  ...
  Future<List<Character>> _toList(List<Map<String, dynamic>> result) async {
    ...
    for (Map<String, dynamic> row in result) {
      final Character character = Character(
          ...
          type: row[_type],
          stars: row[_stars],
          mine: convertIntToBool(row[_mine]));
